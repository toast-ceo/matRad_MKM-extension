classdef matRad_MKMRBEProjection < matRad_EffectProjection
% matRad_MKMRBEProjection class for RBE-weighted dose optimization
%
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = matRad_MKMRBEProjection()
        end
        
        function RBExD = computeSingleScenario(obj,dij,scen,w)
            
            dij = matRad_calcMKMDose(dij,w);
            ...
            RBExD(dij.ixDose) = (sqrt((effect(dij.ixDose)./dij.bx(dij.ixDose))+(dij.gamma(dij.ixDose).^2)) - dij.gamma(dij.ixDose)) * 2.39;
        end
